...
file = (File.open(File.join(Rails.root, '/public/images/car_crash.jpg')))
post = Post.create!(text_overlay: "test", photo: file, photo_link: "https://s3.amazonaws.com/goodevil/", user_id: u2.id)
